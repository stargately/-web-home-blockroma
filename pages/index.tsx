...
import {SiteScripts} from "../src/site-scripts";
import Head from 'next/head';
import {CompetitiveAnalysis} from "../src/competitive-analysis";
import {Birdview} from "../src/birdview";
import {SubscribeFormLarge} from "../src/subscribe-form/subscribe-form-large";
...
const Home: NextPage = () => {
  ...
  const opts = {
    ...
    heroDesc: "Built with TypeScript, React, and PostgreSQL. Easy to customize and deploy in minutes.",
    heroCtaText: "Contact Sales",
    heroCtaTextLink: "https://t.me/mikethrift",
    heroCtaTextSecondary: "Fork me on Github",
    heroCtaTextSecondaryLink: "https://github.com/stargately/blockroma",
    heroCtaSecondaryText: "Already using Blockroma?",
    heroCtaSecondaryTextButton: "Go to App",
    heroCtaSecondaryTextButtonLink: "https://app.blockroma.com/",

    featTitle: "Solution tailored to the fast-moving web3 industry",

    feat1Title: "Open Source",
    feat1Desc: "A blockchain explorer visualizing your blockchain transactions, blocks, ERC20 and ERC721 tokens in realtime, with a community-driven development.",
    feat1CtaText: "Learn More",
    feat1CtaLink: "https://stargately.com/docs/blockroma",

    feat2Title: "Modern Stack",
    feat2Desc: "Extensibility and maintainability achieved by TypeScript, React, GraphQL, and PostgreSQL with the largest developer community. Deploy in <strike>hours</strike> minutes.",
    feat2CtaText: "Learn More",
    feat2CtaLink: "https://github.com/stargately/blockroma",

    feat3Title: "Managed Hosts",
    feat3Desc: "We provide custom themes, premium supports, and priority updates to managed hosting on blockroma.com. It's worry-free with zero operation costs for you.",
    ...
    onboardingSteps: [
      ["1. Download source code", "git clone https://github.com/stargately/blockroma"],
      ["2. Customize to your chain", "follow instructions", "https://stargately.com/docs/blockroma#how-does-it-work"],
  ...
  return (
    <>
      ...
      <section className="has-divider">
        <div className="container">
          <div className="row align-items-center justify-content-between o-hidden">
            <div className="col-md-6 order-sm-2 mb-5 mb-sm-0" data-aos="fade-left">
            ...
            <div className="col-md-6 pr-xl-5 order-sm-1">
              ...
              <form className="d-sm-flex mb-2 mt-4">
                <a className="btn btn-lg btn-primary mr-1 mb-1" target="_blank" href={opts.heroCtaTextLink} rel="nofollow noreferrer noopener">
                  {opts.heroCtaText}
                </a>
                <a className="btn btn-lg btn-secondary mr-1 mb-1" target="_blank" href={opts.heroCtaTextSecondaryLink} rel="nofollow noreferrer noopener">
              ...
              <span className="text-small text-muted">
                ...
                {" "}
                <a href={opts.heroCtaSecondaryTextButtonLink}>{opts.heroCtaSecondaryTextButton}</a>
          </span>
            </div>
          </div>
        </div>
          ...
          <div className="row">
            ...
            <div className="col-md-4" data-aos="fade-up" data-aos-delay={200}>
              <div className="card card-body">
                ...
                <p dangerouslySetInnerHTML={{__html: opts.feat2Desc}}>
                </p>
                {opts.feat2CtaLink && (
            ...
            <div className="col-lg-6">
              ...
              <div className="row mt-5 o-hidden">
                {opts.integrations.map((integration, idx) => (
                  <div key={integration.title} className="col-sm-6" data-aos="fade-left" data-aos-delay={idx * 100}>
                    <a
          ...
          <div className="row justify-content-between align-items-center o-hidden">
            <div className="col-md-6 col-lg-5">
              {opts.onboardingSteps.map(s => (
                <div key={s[0]} className="d-flex mb-4" data-aos="fade-up" data-aos-delay="NaN">
      ...
      <a href="#" className="btn back-to-top btn-primary btn-round" data-smooth-scroll data-aos="fade-up"
