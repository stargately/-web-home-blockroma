...
export const SiteFooter: React.FC = () => {
  const opts = {
    ...
    navigateItems: [["Stargately Home", "https://stargately.com/"], ["Beancount.io", "https://beancount.io/"], ["10x.pub", "https://10x.pub/"]],

    contactTitle: "Contact",
    contactAddress: ["601 Van Ness Avenue", "San Francisco, CA"],
    contactPhone: ["Mike Thrift", "https://t.me/mikethrift", "Singapore Time (SGT) Mon - Fri 7am - 3pm"],
          ...
          <div className="col-6 col-lg">
            ...
            <ul className="list-unstyled">
              ...
              <li className="mb-3 d-flex">
                ...
                />
                <div className="ml-3">
                  <a href={opts.contactPhone[1]} rel="noreferrer nofollow noopener">{opts.contactPhone[0]}</a>
