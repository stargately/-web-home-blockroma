...
export const CompetitiveAnalysis: React.FC = () => {
  const meta = {
    ...
    competitiveAnalysisDesc: "It's built for blockchains that are moving fast with modern stack.",
    ...
    competitors: [
      {
        head: "https://tp-misc.b-cdn.net/blockroma-logo.svg",
        primary: true,
    ...
    recommendations: [
      ...
      },
      {
        ...
        words: "It's amazing to set up Blockroma in 10 minutes instead of hours.",
        name: "Yuan L.",
        title: "Software Engineer",
      },
      {
        icon: "assets/img/avatars/nico-m.jpg",
        words: "Blockroma simplifies our tech stack but I am hoping to see more features.",
        name: "Nico M.",
      ...
      <div className="container">
        <div className="row justify-content-center text-center mb-6">
          <div className="col-xl-8 col-lg-9">
            <h2 className="display-4 mx-xl-6">{meta.competitiveAnalysisTitle}</h2>
            <p className="lead">
              {meta.competitiveAnalysisDesc}
            </p>
          </div>
        </div>
          ...
          <div className="col-xl-10" data-aos="fade-up">
            <table className="table pricing-table pricing-table-competitors">
              ...
              <tr>
                ...
                {meta.competitors.map(competitor => (
                  <th scope="col" className={classnames({"bg-primary-alt": competitor.primary})} key={competitor.head}>
                    <img src={competitor.head} alt="Image" width={48} height={48}/>
                  </th>
                ))}
              </tr>
              </thead>
                  ...
                  </th>
                  {
                    meta.competitors.map((competitor) => (
                      competitor.items[row] ? (
                        <td className={classnames({"bg-primary-alt": competitor.primary})} key={competitor.head}>
                          <div
                            className={classnames("icon-round icon-round-xs", competitor.primary ? "bg-success" : "bg-primary-3-alt")}>
                            <img
                              className={classnames("icon", competitor.primary ? "bg-light" : "bg-primary-3")}
            ...
            {meta.competitiveAnalysisCtaText && (
              <div className="text-right">
                <a href={meta.competitiveAnalysisCtaLink} className="hover-arrow">
                  {meta.competitiveAnalysisCtaText}
                </a>
              </div>
            )}
